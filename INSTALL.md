...
Get `Ember_0.1.7_aarch64.dmg` onto the other Mac — **AirDrop**, a USB stick, or any file transfer.
(After a build it lives at `src-tauri/target/release/bundle/dmg/Ember_0.1.7_aarch64.dmg`.)
